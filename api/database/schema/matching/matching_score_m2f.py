...
class ScoreMToF(Base, BaseMixin):
    __tablename__ = 'matching_score_m2f'
    female_id = Column(BIGINT, primary_key=True, default=func.max(User.id))
    male_id = Column(BIGINT, primary_key=True, default=func.max(User.id))
