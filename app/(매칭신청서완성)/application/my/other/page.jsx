      ...
      >
        ...
        <Container disableGutters sx={{
          ...
          <Container disableGutters sx={{display:'flex',flexDirection:'column',gap:'0px'}}>
            <Typography className='basic-gray'>카카오톡 아이디</Typography>
            <TextInput data={data} setData={setData} data_name={"kakao_id"} title={"여기에 카카오톡 아이디를 입력해주세요"} />
          </Container>
        </Container>
        <Container disableGutters sx={{
          display: 'flex',
        ...
        <Container disableGutters sx={{
          ...
          <MainButton buttonName="내 정보 입력 완료" onClick={() => { handleNext() }} />
        ...
        <Modal clicked={showModal} setClicked={setShowModal}>
          ...
          <Link href="/application/target">
            <MainButton buttonName='이상형 입력하기' />
          </Link>
        </Modal>
      </Container>
